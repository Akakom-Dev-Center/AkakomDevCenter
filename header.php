...
<head>
 ...
 <base  />
   ...
   <link rel="stylesheet" type="text/css" href="theme/css/fonts/font-awesome/css/font-awesome.css">
   <link rel="stylesheet" type="text/css" href="theme/css/custom.css"/>
   <link rel="stylesheet" type="text/css" href="theme/css/theme-responsive.css" />
   ...
   <script type="text/javascript" src="theme/vendor/modernizr.js"></script>

   <link rel="stylesheet" href="scripts/article.css"/>
   <link rel="stylesheet" href="scripts/modul.css"/>     
<!-- Custom CSS & JS 
   <link rel="stylesheet" href="scripts/detotty.css"/>
   <link rel="stylesheet" type="text/css" href="scripts/style.css" />
   
   <link rel="stylesheet" href="scripts/main_home.css"/>
   <link rel="stylesheet" href="scripts/style_appwarp.css"/> 
-->
   <!-- CSS related changes -->
               ...
               <ul class="nav nav-pills nav-main" id="mainMenu">
                  ...
                  <li class="dropdown mega-menu-item mega-menu-signin signin" id="headerAccount">
                     ...
                     <ul class="dropdown-menu">
                        <li><a class="dropdown" href="kategori.php">Categories</a></li>
                        <li><a class="dropdown" href="sub-kategori.php">Sub Categories</a></li>
                     </ul>
                  </li>
               </ul>
            </nav>
